...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 15 juin 2021 à 21:46
...
INSERT INTO `camion` (`id`, `immatriculation`) VALUES
(1, 'abcd'),
(2, 'efg');
...
CREATE TABLE IF NOT EXISTS `mission` (
  ...
  `isArrived` tinyint NOT NULL DEFAULT '0',
  `date_depart` varchar(20) DEFAULT NULL,
  `date_arriver` varchar(20) DEFAULT NULL,
...
INSERT INTO `mission` (`id`, `consommation_capter`, `long`, `isArrived`, `date_depart`, `date_arriver`, `id_conducteur`, `id_ville_depart`, `lat`, `id_ville_arriver`) VALUES
(2, 2.000, '123', 1, '2019-1-1', '2019-1-2', 1, 1, '123', 15),
(3, NULL, NULL, 0, '1,Rabat', '2020-02-20', 3, 1, NULL, 15);
...
INSERT INTO `suivi` (`id`, `id_camion`, `id_mission`) VALUES
(1, 1, 2);
